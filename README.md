...
All three dialogue-continuity mechanisms above are covered by 17 new end-to-end tests using the real deterministic verb path (no LLM interpreter mocks) on branch `test/m7-read-followup-regression-20260920` — 111/111 backend files, 2037/2037 tests passing on that branch, mobile 49/49 files, 824/824 unaffected (no mobile changes needed), `tsc` clean.
