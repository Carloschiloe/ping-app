...
export const createCommitmentSchema = z.object({
    body: z.object({
        ...
        due_at: z.string().refine((val) => !isNaN(Date.parse(val)), { message: "Invalid date format" }).optional().nullable(),
...
export const updateCommitmentSchema = z.object({
    ...
    body: z.object({
        ...
        proposed_due_at: z.string().refine((val) => !isNaN(Date.parse(val)), { message: "Invalid date format" }).optional().nullable(),
        meta: z.record(z.string(), z.any()).optional().nullable(),
    })
});
