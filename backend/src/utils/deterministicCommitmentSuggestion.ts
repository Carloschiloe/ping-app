...
const ACTION_PATTERN = /\b(agend(?:a|ar|emos?)|tarea|compromiso|record(?:ar|atorio)|reuni[oó]n|cita|llam(?:ar|emos?)|envi(?:ar|emos?)|pag(?:ar|aremos?)|compr(?:ar|aremos?)|llev(?:ar|aremos?)|busc(?:ar|aremos?)|reserv(?:ar|aremos?)|entreg(?:ar|aremos?)|present(?:ar|aremos?)|hacer|tengo que|tenemos que|hay que|debemos|quedamos|veremos|vemos|junt(?:ar|amos|émonos)|ir a|iremos)\b/i;
const MEETING_PATTERN = /\b(reuni[oó]n|cita|llamada|llamar|junta|junt(?:ar|amos|émonos)|veremos|vemos|quedamos)\b/i;
