...
export const M7_FRONTIER_CASES: FrontierCase[] = [
    ...
    { id:'F08', utterance:'Lo de la bomba, mejor el viernes.', expected:{kind:'write_request',domain:'commitment'}, dialogue:{lifecycle:'active',activeObjectiveType:'reschedule_existing_commitment',missingSlotType:null,suspendedObjectiveType:null,referentHints:['revisar bomba']} },
    { id:'F09', utterance:'¿Cuándo era lo de la bomba?', expected:{kind:'read_request'} },
    // Without a durable memory referent or an explicit supported operation,
    // this is intentionally uncertain; inventing a delete action would be a
    // worse certification outcome than asking for context.
    { id:'F10', utterance:'Borra eso de mi cabeza, no lo guardes.', expected:{kind:'unknown'} },
    ...
    { id:'F16', utterance:'¿Qué onda con eso?', expected:{kind:'unknown'} },
    ...
    { id:'F23', utterance:'Dalo por terminado.', expected:{kind:'write_request',domain:'commitment'}, dialogue:{lifecycle:'active',activeObjectiveType:'complete_existing_commitment',missingSlotType:null,suspendedObjectiveType:null,referentHints:['revisar bomba']} },
    { id:'F24', utterance:'¿Lo dimos por terminado?', expected:{kind:'read_request',domain:'commitment'} },
    { id:'F25', utterance:'Cámbialo pa pasado mañana en la tarde.', expected:{kind:'write_request',domain:'commitment'}, dialogue:{lifecycle:'active',activeObjectiveType:'reschedule_existing_commitment',missingSlotType:'time',suspendedObjectiveType:null,referentHints:['revisar bomba']} },
